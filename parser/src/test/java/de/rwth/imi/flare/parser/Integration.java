...
public class Integration {
    ...
    @Test
    public void testParser() throws IOException, JAXBException, TransformerConfigurationException {
        ...
        criterion1 = new Criterion(
                new TerminologyCode("\\\\i2b2_DIAG\\i2b2\\Measurements\\Lymphozyten\\", "i2b2_sim"),
                new ValueFilter(FilterType.QUANTITY_COMPARATOR, null, Comparator.LT, 40.0, "%", null, null, null));
        Criterion criterion2 = new Criterion(
                new TerminologyCode("\\\\i2b2_DIAG\\i2b2\\Measurements\\Lymphozyten_absolut\\", "i2b2_sim"),
        ...
        criterion1 = new Criterion(new TerminologyCode("\\\\i2b2_DIAG\\i2b2\\Measurements\\Bilirubin\\", "i2b2_sim"),
                new ValueFilter(FilterType.QUANTITY_COMPARATOR, null, Comparator.LT, 8.0, "mg/dl", null, null, null));
        criterion2 = new Criterion(new TerminologyCode("\\\\i2b2_DIAG\\i2b2\\Measurements\\Bilirubin_direkt\\", "i2b2_sim"),
