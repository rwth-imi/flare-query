...
public class Integration {
    ...
    public void testParser() throws IOException, TransformerConfigurationException {
        ...
        TerminologyCode male_terminology = new TerminologyCode("\\\\i2b2_DEMO\\i2b2\\Demographics\\Gender\\Male\\", "i2b2_sim", null);
        ...
        criterion1 = new Criterion(
                new TerminologyCode("\\\\i2b2_DIAG\\i2b2\\Measurements\\Lymphozyten\\", "i2b2_sim", null),
                new ValueFilter(FilterType.QUANTITY_COMPARATOR, null, Comparator.LT, 40.0, "%", null, null), null);
        Criterion criterion2 = new Criterion(
                new TerminologyCode("\\\\i2b2_DIAG\\i2b2\\Measurements\\Lymphozyten_absolut\\", "i2b2_sim", null),
        ...
        criterion1 = new Criterion(new TerminologyCode("\\\\i2b2_DIAG\\i2b2\\Measurements\\Bilirubin\\", "i2b2_sim", null),
                new ValueFilter(FilterType.QUANTITY_COMPARATOR, null, Comparator.LT, 8.0, "mg/dl", null, null), null);
        criterion2 = new Criterion(new TerminologyCode("\\\\i2b2_DIAG\\i2b2\\Measurements\\Bilirubin_direkt\\", "i2b2_sim", null),
